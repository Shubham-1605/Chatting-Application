...
public class Server extends JFrame implements ActionListener{
    ...
    Server(){
        ...
        more.setBounds(405,23,10,25);
        p1.add(more);
        
        JLabel name = new JLabel("lohani");
        ...
        status.setBounds(100,35,80,25);
        status.setForeground(Color.WHITE);
        status.setFont(new Font("SAN SERIEF",Font.BOLD,12));
        p1.add(status);
        ...
        send.setBounds(315,565,123,40);
        send.setFont(new Font("SANS SERIEF",Font.PLAIN,16));
